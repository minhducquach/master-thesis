...
\option{Foundations and Advanced Methods in Machine Learning} 
\title{Real-time RGB-D Depth Completion using Knowledge Distillation} %\\\vspace{-1ex}\rule{10ex}{0.5pt} \\sub-title} 
\author{QUACH Minh-Duc}
\date{Defense Date, 2026} % Delete this line to display the current date
\jury{
Research project performed at GIPSA-Lab \\\medskip
Under the supervision of:\\
Amaury Nègre\\\medskip
Defended before a jury composed of:\\
Head of the jury\\
Jury member 1\\
Jury member 2\\
}
\session{June \hfill 2026}
...
Your abstract in French goes here... Ok
\end{abstract}
...
\include{./chapters/2_Related_Works}
